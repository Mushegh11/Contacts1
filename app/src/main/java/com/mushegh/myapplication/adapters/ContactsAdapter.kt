...
import com.mushegh.myapplication.fragments.ShowContactsFragment
import kotlin.reflect.typeOf

class ContactsAdapter(items : List<Contact>, context : Context , interfaceClick : OnAdapterItemClickListener) : RecyclerView.Adapter<ContactsAdapter.ContactsViewHolder>() {
...
//              // listener?.inItemLongClick(currentUser,position)
...
//        }
    ...
    interface OnAdapterItemClickListener{
        ...
        fun inItemLongClick(current : Contact,position : Int)
    }
}